...
header('Content-Type: application/pdf');
    ...
    function createPdfForWork($idwork){
        ...
        foreach ($work->practices as $practice) {
            ...
            $title = iconv('UTF-8', 'windows-1252', $practice->duration_m.'m  '.$practice->title);
            ...
            $pdf->MultiCell(150,4,$description);
            ...
            foreach ($completePratice->circuitItems as $circuitItem) {
                ...
                $pdf->SetFont('Arial','',8);
                $pdf->MultiCell(100,4,$count.") ". $description);

                $pdf->SetFont('Arial','I',8);
                $pdf->MultiCell(150,4,"           ". $equipment);
